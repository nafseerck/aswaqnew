  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (widget.name != "from filter") {
        ...
        // if(widget.name == "On Sale"){
        //   await  getProductListOnsale(
        //       widget.categoryId);
        //
        // } else {
        await getProductList(widget.categoryId);
        // }
...
//                                                fontWeight: FontWeight.bold,
  ...
  Future getProductList(int catId) async {
    ApiRepository.loadMoreProduct(catId, currentProductCount)
          ...
          for (var i = 0; i < categoryList.childrenData.length; i++) {
            for (int j = 0;
              ...
              for (int k = 0;
                  ...
                  k++) {
                setState(() {
                  if (categoryList.childrenData[i].childrenData[j]
                          .childrenData[k].parentId ==
                      widget.categoryId) {
                    print("wwwwwwwww");
                    print(categoryList
                        .childrenData[i].childrenData[j].childrenData[k].id);
                    catName.add(categoryList
                        .childrenData[i].childrenData[j].childrenData[k].name);
                    level1CatId.add(categoryList
                        .childrenData[i].childrenData[j].childrenData[k].id);
                  }
                });
              }
...
//            }
          ...
          print(level1CatId[1]);
          print(level1CatId[2]);
          _key.currentState.showBottomSheet((context) => Filters(
              "From ShowSearchProduct",
