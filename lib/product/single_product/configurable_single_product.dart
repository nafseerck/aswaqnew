...
class ConfirabaleProducts extends StatefulWidget {
  ...
  String productType;
  ConfirabaleProducts(
      this.productList, this.index, this.sku, this.price, this.productType);
                                ...
                                image: DecorationImage(
                                  image: NetworkImage(
                                      "https://aswaqrak.ae/pub/media/catalog/product/cache/9e61d75d633e5fc1a695bad0376a2475" +
                                          widget.productList.items[widget.index]
...
//                          ,
                              ...
                              SizedBox(
                                ...
                                child: FlatButton(
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      if (widget.productList.items[widget.index]
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  SizedBox(
                                    ...
                                    child: Text(
                                      widget
                                          .productList.items[widget.index].name,
                                      maxLines: 2,
                            ...
                            child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      widget
                                          .productList.items[widget.index].sku,
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontSize: 15,
                                          fontWeight: FontWeight.bold,
...
//    i++) {
    ...
    setState(() {
      attributeId = widget.productList.items[widget.index].extensionAttributes
          .configurableProductOptions[0].attributeId;
      oprionLabel = widget.productList.items[widget.index].extensionAttributes
          .configurableProductOptions[0].label;
      for (int i = 0;
          i <
              widget.productList.items[widget.index].extensionAttributes
                  .configurableProductOptions[0].values.length;
          i++) {
        optionValueLis.add(widget
            .productList
            .items[widget.index]
            .extensionAttributes
            .configurableProductOptions[0]
            .values[i]
            .valueIndex
            .toString());
      }
