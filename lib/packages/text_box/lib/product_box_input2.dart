...
/// The same can be read as a string from [NumberInputWithIncrementDecrement2.controller].
...
class NumberInputPrefabbed extends NumberInputWithIncrementDecrement2 {
  ...
  /// Defaults to [_NumberInputWithIncrementDecrement2State._minMaxValidator] validator
...
class NumberInputWithIncrementDecrement2 extends StatefulWidget {
  /// Key to be used for this widget.
  final Key key;
  ...
  NumberInputWithIncrementDecrement2({
    @required this.controller,
    this.key,
    this.enabled = true,
    this.buttonArrangement = ButtonArrangement.rightEnd,
  ...
  @override
  _NumberInputWithIncrementDecrement2State createState() =>
      _NumberInputWithIncrementDecrement2State();
}

class _NumberInputWithIncrementDecrement2State
    extends State<NumberInputWithIncrementDecrement2> {
