...
/// The same can be read as a string from [NumberInputWithIncrementDecrement3.controller].
...
class NumberInputPrefabbed extends NumberInputWithIncrementDecrement3 {
  ...
  /// Defaults to [_NumberInputWithIncrementDecrement3State._minMaxValidator] validator
...
class NumberInputWithIncrementDecrement3 extends StatefulWidget {
  /// Key to be used for this widget.
  final Key key;
  ...
  NumberInputWithIncrementDecrement3({
    @required this.controller,
    this.key,
    this.enabled = true,
    this.buttonArrangement = ButtonArrangement.rightEnd,
  ...
  @override
  _NumberInputWithIncrementDecrement3State createState() =>
      _NumberInputWithIncrementDecrement3State();
}

class _NumberInputWithIncrementDecrement3State
    extends State<NumberInputWithIncrementDecrement3> {
...
//                  ],
  ...
  Container _buildDecrementButton() {
    return Container(
      width: MediaQuery.of(context).size.width *
          .2-35,
      height: 45,
        ...
        decoration: widget.decIconDecoration ??
            BoxDecoration(
              border: widget.buttonArrangement == ButtonArrangement.leftEnd ||
                  ...
                  ? null
                  : Border(
                top: BorderSide(color: HexColor("e25814")),
                bottom: BorderSide(color: HexColor("e25814")),
              ),
            ),
        child: InkWell(
  ...
  Container _buildIncrementButton() {
    return Container(
      width: MediaQuery.of(context).size.width *
          .2-35,
      height: 45,
