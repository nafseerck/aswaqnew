...
/// The same can be read as a string from [NumberInputWithIncrementDecrement4.controller].
...
class NumberInputPrefabbed extends NumberInputWithIncrementDecrement4 {
  ...
  /// Defaults to [_NumberInputWithIncrementDecrement4State._minMaxValidator] validator
...
class NumberInputWithIncrementDecrement4 extends StatefulWidget {
  /// Key to be used for this widget.
  final Key key;
  ...
  @override
  _NumberInputWithIncrementDecrement4State createState() =>
      _NumberInputWithIncrementDecrement4State();
}

class _NumberInputWithIncrementDecrement4State
    extends State<NumberInputWithIncrementDecrement4> {
